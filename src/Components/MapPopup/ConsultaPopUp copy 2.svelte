     ...
     // console.log('despres', highliItem)
      ...
      if (consulta_show) { 
         ...
         if (elementsArray.length !== 0 && tallArray.length !== 0 ){
               ...
               var descarregaTall = `<a href="${element.properties.LINK_ZIP}" style="color: #1a4971">Descarrega el tall</a>`
            ...
            //MODIFICAR EL SEGON CCONDICIONAL PERQUE QUEDI RELACIONAT AMB CLICK A TALLS
            ...
            if (elementsArray.length !== 0  && tallArray.length == 0){
                    ...
                    text =
                                            text + 
                                                        `<div>
                                                          <p style="color: #666">${episArray}: ${elementsArray[0]}</p>
